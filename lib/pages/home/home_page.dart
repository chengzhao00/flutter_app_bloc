...
import 'package:flutter_app_bloc/pages/web/web_plugin_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _homeListData(
      {List<BannerEntity> bannerData, List<HomeProjectEntity> data}) {
    return CustomScrollView(
      slivers: <Widget>[
        ...
        SliverList(
            delegate: SliverChildBuilderDelegate(_homeListItem,
  ...
  Widget _homeListItem(BuildContext context, int index) {
    if (homelist == null || homelist.length == 0) {
      ...
      return Container(
          child: ListItem(
              ListItemEntity(entity.title, entity.desc, entity.envelopePic,
                  entity.author, "09-09"),
              onTap: () {
              ...
              builder: (context, state) {
                ...
                if (state is HomeDataState) {
                  ...
                  return _homeListData(
                      bannerData: state.bannerList, data: state.homeList);
                }
